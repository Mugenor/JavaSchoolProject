...
<div class="limiter">
    <div class="container-login100" style="background-image: url('/resource/images/bg-01.jpg');">
        <div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
            <sf:form cssClass="login100-form validate-form flex-sb flex-w" method="post" commandName="newUser">
                ...
                <div class="wrap-input100 validate-input" data-validate="Name is required">
                    <sf:input cssClass="input100" path="name"/>
                ...
                <div class="wrap-input100 validate-input" data-validate="Surname is required">
                    <sf:input cssClass="input100" path="surname"/>
                    <span class="focus-input100"></span>
                </div>
                ...
                <div class="wrap-input100 validate-input" data-validate="Username is required">
                    <sf:input cssClass="input100" path="username"/>
                    <span class="focus-input100"></span>
                </div>
                ...
                <div class="wrap-input100" data-validate="Password is required">
                    <sf:password cssClass="input100" path="password"/>
                    <span class="focus-input100"></span>
                </div>
...
<script src="<c:url value="/resource/js/register.js"/> " type="text/javascript"></script>
</body>
</html>
